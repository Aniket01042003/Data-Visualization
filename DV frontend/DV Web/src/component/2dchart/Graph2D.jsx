...
const Graph2D = () => {
    ...
    return (
        <div className="flex h-screen bg-black text-[#00acc1]">
            {/* Sidebar */}
            <aside className="w-[20%] bg-black/40 backdrop-blur-md p-4 rounded-xl ">
            {/* shadow-[0_0_20px_#00acc1] border border-[#00acc1]/30 */}
            ...
            <main className="flex-1 flex flex-col items-center ">
                <div className="w-[80%] mt-5 mb-5 h-fit p-4 pb-6 flex justify-between" >
                    <h2 className="text-2xl font-bold">{dataSet?.datasetName || "2D Chart"}</h2>
                    <div className="flex gap-4">
                        <button
                            className="px-4 py-2 bg-[#00acc1] hover:bg-[#008b9a] text-black rounded-md transition"
                            onClick={downloadPDF}
                        >
                            Download PDF
                        </button>
                ...
                <div className="bg-black/40 backdrop-blur-md p-4 mt-15 rounded-lg shadow-[0_0_30px_#00acc1] w-[80%] h-[70%] flex justify-center items-center">
