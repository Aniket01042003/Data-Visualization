...
const Graph3D = () => {
    ...
    return (
        <div className="h-screen flex bg-gradient-to-br from-black via-gray-900 to-black text-white">
            {/* Sidebar */}
            <aside className="w-[20%] bg-black/40 backdrop-blur-md p-4 rounded-r-xl  border-r border-[#00acc1]/30">
            ...
            {!loading && <div className="flex-1 flex justify-center items-center">
                <div
                    ref={mountRef}
                    className="w-[90%] h-[90%] rounded-lg shadow-lg border border-[#00acc1]/20"
                ></div>
            </div>}
