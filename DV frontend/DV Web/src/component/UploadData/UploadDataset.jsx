                                ...
                                <div className="grid gap-2">
                                    ...
                                    <div className="flex items-center justify-center">
                                        <label>
                                            ...
                                            />
                                            <div className="flex w-28 h-9 px-2 flex-col bg-indigo-600 rounded-full shadow text-white text-xs font-semibold items-center justify-center cursor-pointer">
                                                Choose File
                                            </div>
                                        </label>
                                    </div>
