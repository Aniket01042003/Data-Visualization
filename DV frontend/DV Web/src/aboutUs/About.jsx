            ...
            <div className="p-20 ">
                <div className="text-center mb-16">
                    ...
                    <h3 className="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900">
                        Meet Our <span className="text-gray-700">Team</span>
                    </h3>
                </div>

                <div className="sm:grid  grid-cols-2 md:grid-cols-4 gap-10 mx-auto">
                    {teamMembers.map((member, index) => (
                        <div key={index} className="text-center max-w-[20rem] bg-green-100 p-4 hover:shadow-2xl hover:shadow-gray-900 shadow-lg rounded-md">
                            <a href="#">
                                <img
